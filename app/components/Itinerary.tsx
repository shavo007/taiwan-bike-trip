  ...
  const schedule = [
    {
      ...
      accommodation: {
        ...
        features:
          'Central location, convenient, hotel buffet breakfast included',
    ...
    },
    {
      ...
      accommodation: {
        ...
        roomType: 'Shared room - two single beds',
        features:
          'Convenient location, nearby traditional building, hotel buffet breakfast included',
    ...
    },
    {
      ...
      accommodation: {
        ...
        type: 'Hotel',
        price: '$210/pax (AUD)',
        roomType: 'Singe occupancy in double room',
        features: 'Conveneint location near MAAP lab',
        bikeStorage: 'Can bring to the room',
        qrCode: 'https://maps.app.goo.gl/Vqcgapks6j3RTsPv5',
      },
