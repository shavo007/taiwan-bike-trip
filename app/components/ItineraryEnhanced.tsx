  ...
  const schedule = [
    {
      ...
      accommodation: {
        ...
        features: 'Central location, convenient, hotel buffet breakfast included',
        bikeStorage: 'Store in meeting room',
    ...
    },
    {
      ...
      description: "Begin your cycling journey at 7am, departing from Kaohsiung and riding south along Taiwan's stunning coastline to Kenting.",
    ...
    },
    {
      ...
      description: 'Continue your journey inland towards the mountains, ending at the relaxing hot springs of Jinlung.',
      stravaRouteID: '3367020249280943442',
      details: {
        distance: '113.69km',
    ...
    },
    {
      ...
      description: "Cycle through Taiwan's beautiful forest landscapes and arrive at the eco-friendly Forest 3030 Hostel.",
      stravaRouteID: '3367020249280943442',
      details: {
        distance: '111.91km',
        estimatedTime: '4.4 hours',
      ...
      accommodation: {
        ...
        price: '$80/pax (AUD)',
        roomType: 'Shared room - two single beds',
        features: 'Boutique style, located in central area with lots of facilities, hotel buffet breakfast included',
        bikeStorage: 'Store in guarded meeting room',
    ...
    },
    {
      ...
      accommodation: {
        ...
        price: '$140/pax (AUD)',
        roomType: 'Shared room - two single beds',
        features: 'Convenient location, nearby traditional building, hotel buffet breakfast included',
        bikeStorage: 'Can bring to the house',
    ...
    },
    {
      ...
      description: "Challenge yourself with a climb to the high-altitude Lishan Guest House in Taiwan's central mountains.",
      stravaRouteID: '3367020249280943442',
      details: {
        distance: '110km',
        estimatedTime: '4.3 hours',
        elevation: '+1206m',
      },
      accommodation: {
        ...
        price: '$100/pax (AUD)',
        roomType: 'Shared room - two double beds',
    ...
    },
    {
      ...
      description: "Descend from the high mountains of Lishan through spectacular scenery to the coastal plains of Yilan. Experience dramatic elevation changes as you cycle from Taiwan's alpine regions down to the beautiful northeastern coastline.",
      stravaRouteID: '3367020249280943442',
      details: {
        distance: '110.0km',
      ...
      accommodation: {
        ...
        price: '$140/pax (AUD)',
        roomType: 'Private villa accommodation',
        features: 'Private villa style, celebrate & rest at Taipei MAAP Lab',
    ...
    },
    {
      ...
      description: 'Complete your epic journey by cycling to Taipei. Celebrate at MAAP Lab and rest after your incredible adventure.',
      stravaRouteID: '3367020249280943442',
      details: {
        distance: '106.12km',
        estimatedTime: '4.2 hours',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            From the vibrant south to the dramatic mountains, experience Taiwan&apos;s diverse landscapes 
            and rich culture on two wheels
          </p>
        </div>
        
        <div className="space-y-8">
          {schedule.map((item, index) => (
            <div key={`${item.day}-${item.title}`} className="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-lg transition-all duration-300 border border-gray-100">
              <div className="grid lg:grid-cols-2 gap-0">
                  ...
                  {item.stravaRouteID && (
                    <div className="grid grid-cols-3 gap-4 mb-6 p-6 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg">
                      <div className="text-center">
                        <div className="text-2xl font-light text-blue-700">{item.details.distance}</div>
                        <div className="text-xs text-blue-600 uppercase tracking-wide font-medium">Distance</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-light text-blue-700">{item.details.estimatedTime}</div>
                        <div className="text-xs text-blue-600 uppercase tracking-wide font-medium">Time</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-light text-blue-700">{item.details.elevation}</div>
                        <div className="text-xs text-blue-600 uppercase tracking-wide font-medium">Elevation</div>
                      </div>
                    </div>
                  )}
                </div>
                ...
                <div className="p-8 bg-gray-50 border-l border-gray-100">
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="font-medium text-gray-900 text-lg">{item.accommodation.name}</div>
                      <div className="text-sm text-gray-500 mb-2">{item.accommodation.type}</div>
                      <div className="text-xl font-light text-blue-600 mb-2">{item.accommodation.price}</div>
                    </div>
                    <div className="text-sm text-gray-600 leading-relaxed">{item.accommodation.features}</div>
                    
                    {/* QR Code */}
                    <div className="mt-6 p-4 bg-white rounded-lg text-center">
                      <div className="text-sm font-medium text-gray-700 mb-3">📍 Location QR Code</div>
                      <QRCodeDisplay 
